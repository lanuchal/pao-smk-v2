...
//         $data['name'] = $worksheet->getCell('D' . $row)->getValue();
//         if ($data['name'] == "") {
//             $data['name'] = "ยังไม่ระบุ";
//         }

//         // ค้นหาข้อมูลจาก database โดยใช้ชื่อ
//         $find = find_one_equipment_model_by_name($data);
...
if (isset($_POST['create'])) {
    ...
    $result = create_equipment_model($data);
    if ($result) {
...
if (isset($_POST['update'])) {
    ...
    $data['name'] = defending($_POST['name']);
    $result = update_equipment_model($data);
    if ($result) {
...
if (isset($_POST['delete'])) {
    $data['id'] = defending($_POST['id']);
    $data['name'] = defending($_POST['name']);
    $result = delete_equipment_model($data);
    if ($result) {
