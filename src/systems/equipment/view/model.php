            ...
            <form method="POST" action="?s=<?= defending($_GET['s']) ?>&p=<?= defending($_GET['p']) ?>">
                ...
                <div class="modal-body border-0">
                    <div class="mb-3 text-center">
                        ...
                        <input type="text" class="form-control" name="name" placeholder="ชื่อรุ่น">
                    </div>
                </div>
...
<div class="card p-4 border-0 shadow">
    ...
    <table class="table table-hover " id="teble_data">
        ...
        <tbody>
            <?php
            $equipment_models = find_all_equipment_model();
            foreach ($equipment_models as $row) { ?>
                <tr>
                            ...
                            <form method="POST" action="?s=<?= defending($_GET['s']) ?>&p=<?= defending($_GET['p']) ?>">
                                ...
                                <div class="modal-body border-0">
                                    <div class="mb-3 text-center">
                                        ...
                                        <label for="name" class="form-label">ชื่อ</label>
                                        <input type="text" class="form-control" name="name" placeholder="ชื่อรุ่น" value="<?= $row['name']; ?>">
                                    </div>
                                </div>
                                <div class="modal-footer border-0">
                                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">ปิด</button>
                            ...
                            <form method="POST" action="?s=<?= defending($_GET['s']) ?>&p=<?= defending($_GET['p']) ?>">
                                ...
                                <div class="modal-body border-0">
                                    <div class="mb-3 text-center">
                                        <input type="hidden" name="id" value="<?= $row['id']; ?>">
                                        <label for="name" class="form-label">ชื่อ</label>
                                        <input type="text" class="form-control" name="name" placeholder="ชื่อรุ่น" value="<?= $row['name']; ?>" disabled>
                                    </div>
                                </div>
                                <div class="modal-footer border-0">
                                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">ปิด</button>
